...
pycrypto = Tk()
pycrypto.title("My Crypto Portfolio")  ## locations are in a table like value from 0 - 10+
...
def my_portfolio():
    api_request = requests.get(
        "https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=300&convert=USD&CMC_PRO_API_KEY=e11beb4c-c725-4e87-8f8d-0481f57f29ca")
        ...
        for coin in coins:
            if api["data"][i]["symbol"] == coin[1]:
                ...
                price = Label(pycrypto, text="${0:.2f}".format(api["data"][i]["quote"]["USD"]["price"]), bg="#F3F4F6",
                              fg="black", font='Lato 12', borderwidth=2, relief="groove")
                price.grid(row=coin_row, column=2, sticky=N + S + E + W)

                amount_ownd = Label(pycrypto, text=coin[2], bg="#F3F4F6", fg="black", font="Lato 12",
                                    padx="5",
                                    pady="5", borderwidth=2, relief="groove")
                amount_ownd.grid(row=coin_row, column=3, sticky=N + S + E + W)
                ...
                current_val = Label(pycrypto, text="${0:.2f}".format(current_value), bg="#F3F4F6",
                                    fg="black", font="Lato 12",
                                    padx="5", pady="5", borderwidth=2, relief="groove")
                current_val.grid(row=coin_row, column=5, sticky=N + S + E + W)

                plcoin = Label(pycrypto, text="${0:.2f}".format(pl_percoin), bg="#F3F4F6", fg=font_color(float("{0:.2f}".format(pl_percoin))), font="Lato 12",
                               padx="5", pady="5", borderwidth=2, relief="groove")
                plcoin.grid(row=coin_row, column=6, sticky=N + S + E + W)

                totalpl = Label(pycrypto, text="${0:.2f}".format(total_pl_coin), bg="#F3F4F6", fg=font_color(float("{0:.2f}".format(total_pl_coin))),
                                font="Lato 12",
                                padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    add_coin = Button(pycrypto, text="Add Coin", bg="white",
                     fg="#142E54", command=insert_coin, font="Lato 12",
                     padx="5", pady="5", borderwidth=2, relief="groove")
    ...
    update_coin_txt = Button(pycrypto, text="Update Coin", bg="white",
                      fg="#142E54", command=update_coin, font="Lato 12",
                      padx="5", pady="5", borderwidth=2, relief="groove")
 ...
 # Delete coin
    ...
    delete_coin_txt = Button(pycrypto, text="Delete Coin", bg="white",
                             fg="#142E54", command=delete_coin, font="Lato 12",
                             padx="5", pady="5", borderwidth=2, relief="groove")
    delete_coin_txt.grid(row=coin_row + 3, column=4, sticky=N + S + E + W)


    totalap = Label(pycrypto, text="${0:.2f}".format(total_amount_paid), bg="#F3F4F6", fg="black", font="Lato 12",
                    padx="5", pady="5", borderwidth=2, relief="groove")
    totalap.grid(row=coin_row, column=4, sticky=N + S + E + W)

    totalcv = Label(pycrypto, text="${0:.2f}".format(total_current_value), bg="#F3F4F6", fg="black", font="Lato 12",
                    padx="5", pady="5", borderwidth=2, relief="groove")
    totalcv.grid(row=coin_row, column=5, sticky=N + S + E + W)

    totalpl = Label(pycrypto, text="${0:.2f}".format(total_pl), bg="#F3F4F6", fg=font_color(float("{0:.2f}".format(total_pl))), font="Lato 12",
                    padx="5", pady="5", borderwidth=2, relief="groove")
    totalpl.grid(row=coin_row, column=7, sticky=N + S + E + W)

    api = ""

    refresh = Button(pycrypto, text="Refresh", bg="white",
                    fg="#142E54", command=reset, font="Lato 12",
                    padx="5", pady="5", borderwidth=2, relief="groove")
    refresh.grid(row=coin_row + 1, column=7, sticky=N + S + E + W)

def app_header():
    port_id = Label(pycrypto, text="Coin Name", bg="#142E54", fg="white", font="Lato 12 bold", padx="5", pady="5",
                 borderwidth=2, relief="groove")
    ...
    price = Label(pycrypto, text="Price", bg="#142E54", fg="white", font="Lato 12 bold", padx="5", pady="5", borderwidth=2,
                 relief="groove")
    price.grid(row=0, column=2, sticky=N + S + E + W)

    num_coin = Label(pycrypto, text="Number of Coins", bg="#142E54", fg="white", font="Lato 12 bold", padx="5", pady="5",
                     borderwidth=2, relief="groove")
    num_coin.grid(row=0, column=3, sticky=N + S + E + W)

    ttlp = Label(pycrypto, text="Total Amount Paid", bg="#142E54", fg="white", font="Lato 12 bold", padx="5", pady="5",
                 borderwidth=2, relief="groove")
    ttlp.grid(row=0, column=4, sticky=N + S + E + W)

    ttlv = Label(pycrypto, text="Total Value", bg="#142E54", fg="white", font="Lato 12 bold", padx="5", pady="5",
                 borderwidth=2, relief="groove")
    ttlv.grid(row=0, column=5, sticky=N + S + E + W)

    plpc = Label(pycrypto, text="P/L Per Coin", bg="#142E54", fg="white", font="Lato 12 bold", padx="5", pady="5",
                 borderwidth=2, relief="groove")
    plpc.grid(row=0, column=6, sticky=N + S + E + W)

    tplpc = Label(pycrypto, text="Total P/L for Coin", bg="#142E54", fg="white", font="Lato 12 bold", padx="5", pady="5",
                  borderwidth=2, relief="groove")
    tplpc.grid(row=0, column=7, sticky=N + S + E + W)
...
# % pyinstaller main.py --onefile --noconsole  TO MAKE EXE File using Pyinstaller in DIST folder
